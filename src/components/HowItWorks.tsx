  ...
  <Phone>
    ...
    <div className="flex-1 flex flex-col items-center justify-between px-5 py-6">
      ...
      <motion.div
        ...
        className="w-full"
      >
        <div className="w-full py-3 bg-blue-600 rounded-2xl flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(59,130,246,0.4)]">
    ...
    <Phone>
      ...
      <div className="flex-1 flex flex-col px-4 py-3">
        ...
        <div className="relative flex items-center justify-center h-28 mb-4">
          ...
          <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center z-10 shadow-[0_0_20px_rgba(59,130,246,0.6)]">
          ...
          {nodes.map((n, i) => (
            ...
            >
              <div className={cn(
                ...
                n.color === "blue"    && "border-blue-500 bg-blue-500/30 shadow-[0_0_10px_rgba(59,130,246,0.5)]",
